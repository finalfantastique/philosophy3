...
class AutoCommitPush:
    ...
    def commit_and_push_file(self, file, change_type='A'):
        ...
        token_fpath = Path("/tmp/token.txt")
        if token_fpath.exists():
            os.system(f"/home/aura/projects/dev/python/send_email/.venv/bin/python /home/aura/projects/dev/python/send_email/main.py AutoCommitPush \"{commit_msg}\"")
